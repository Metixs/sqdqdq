...
client.on("guildMemberRemove", member => {
 ...
 ~~#~~ 1 - \`${prefix}invites\` : invitate
 ~~#~~ 2 - \`${prefix}config joinMessageChannel\` : invite room
 ~~#~~ 3 - \`${prefix}config leaveMessageChannel\` : leave room
 ~~#~~ 4 - \`${prefix}config show \` : seeting dyalak
 ~~#~~ 5 - \`${prefix}config reset-invites\` : tasifire invitate
 ~~#~~ 8 - \`${prefix}config prefix\` : changer prefix
**
\`By : Metix\``);
